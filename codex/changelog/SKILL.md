---
name: changelog
description: Create or update doc/changelog.txt from git commit history. Use when the user asks for a changelog, release notes from git history, or to document what changed in a branch.
---
